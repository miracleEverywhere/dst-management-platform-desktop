          ...
          <v-row class="mt-0">
            <v-col>
              <v-number-input v-model="systemSettingForm.schedulerSetting.playerGetFrequency"
                              ...
                              :min="1"
                              variant="outlined"
                              control-variant="hidden" inset label="玩家列表获取频率">
          ...
          <v-row class="mt-0">
            <v-col>
              <v-number-input v-model="systemSettingForm.schedulerSetting.UIDMaintain.frequency"
                              ...
                              control-variant="hidden" inset label="玩家昵称字典写入频率" variant="outlined">
                <template #append-inner>
          ...
          <v-row class="mt-0">
            <v-col>
              <v-number-input v-model="systemSettingForm.schedulerSetting.playerUpdateMod.frequency"
                              ...
                              :min="1"
                              :disabled="systemSettingForm.schedulerSetting.UIDMaintain.disable"
                              control-variant="hidden" inset label="玩家更新模组检查频率" variant="outlined">
                <template #append-inner>
                  <div style="width: 50px">分钟</div>
                </template>
              </v-number-input>
          ...
          <v-row class="mt-0">
            <v-col>
              <v-radio-group v-model="systemSettingForm.sysSetting.autoRestart.enable"
                             ...
                             inline color="success" class="mt-2">
                <template #prepend>
                  <span>
                    自动重启开关
                  </span>
          ...
          <v-row class="mt-0">
            <v-col>
              <v-number-input v-model="systemSettingForm.sysSetting.backupClean.days"
                              ...
                              control-variant="hidden" inset label="备份保留天数" variant="outlined">
                <template #append-inner>
          ...
          <v-row class="mt-0">
            <v-col>
              <v-number-input v-model="systemSettingForm.sysSetting.keepalive.frequency"
                              ...
                              control-variant="hidden" inset label="自动保活检测频率" variant="outlined">
                <template #append-inner>
                  <div style="width: 50px">分钟</div>
                </template>
              </v-number-input>
